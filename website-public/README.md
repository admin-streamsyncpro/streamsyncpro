# Stream Sync Pro LIVE Public Website

Upload the contents of this folder to your website root if you want the public marketing page on:

- `https://streamsyncpro.co.uk/`
...
- `public_html/downloads/Stream-Sync-Pro-LIVE-Setup-1.0.20.exe`

Notes:

- The main download button now points to a website-hosted installer at `/downloads/Stream-Sync-Pro-LIVE-Setup-1.0.20.exe`.
