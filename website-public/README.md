...
- `public_html/downloads/Stream-Sync-Pro-LIVE-Setup-1.0.13.exe`

Notes:

- The main download button now points to a website-hosted installer at `/downloads/Stream-Sync-Pro-LIVE-Setup-1.0.13.exe`.
